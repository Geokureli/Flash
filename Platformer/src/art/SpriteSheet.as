package art 
{
	...
	public class SpriteSheet 
	{
		...
		public function clearBG(color:uint = -1):void {
			// --- IF NO COLOR PROVIDED REMOVE COLOR OF TOP-LEFT PIXEL
			if (color == -1) color = graphic.getPixel(0, 0);
			graphic.threshold(graphic, graphic.rect, new Point(), "==", 0xFF000000, 0,0xFFFFFFFF, true);
		}
