package baseball.states.play {
	...
	public class Hero extends KrkSprite {
		...
		[Embed(source = "../../../../res/baseball/sprites/hero2.png")] static private const SPRITES:Class;
		
		// --- --- --- --- --- SFX --- --- --- --- ---
		[Embed(source="../../../../res/baseball/audio/sfx/jump.mp3")] static private const SND_JUMP:Class;
		[Embed(source="../../../../res/baseball/audio/sfx/slide.mp3")] static private const SND_SLIDE:Class;
		[Embed(source="../../../../res/baseball/audio/sfx/duck.mp3")] static private const SND_DUCK:Class;
