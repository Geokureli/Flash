package baseball.states.editor {
	...
	public class EditorState extends FlxState {
		[Embed(source = "../../../../res/baseball/sprites/bomb_overlay.png")]	static private const BOMB_BTN_EMBED:Class;
		[Embed(source = "../../../../res/baseball/sprites/base.png")]			static private const BASE_BTN_EMBED:Class;
		[Embed(source = "../../../../res/baseball/sprites/playback.png")]		static private const PLAYBACK_EMBED:Class;
