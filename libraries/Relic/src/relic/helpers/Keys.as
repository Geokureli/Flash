package relic.helpers {
	...
	public class Keys {
		...
		static private const redirects:Dictionary = new Dictionary();
		...
		static private function addRedirect(key:int, target:int):void {
			redirects[key] = target;
		}
		
		static private function removeRedirect(key:int):void {
		...
		static private function keyHandle(e:KeyboardEvent):void {
			...
			if(e.keyCode in redirects && watchers[redirects[e.keyCode]] != null)
				watchers[redirects[e.keyCode]].state = e.type == KeyboardEvent.KEY_DOWN;
		}
