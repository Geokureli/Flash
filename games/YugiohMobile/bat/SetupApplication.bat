...
:: Android packaging
set AND_CERT_NAME="YugiohMobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\YugiohMobile.p12
...
set IOS_PROVISION=cert\YugiohMobile.mobileprovision
...
set APP_ID=air.YugiohMobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=YugiohMobile
