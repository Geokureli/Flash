	...
	public class BeatKeeper {
		...
		static public function update():void {
			...
			if (soundBeats != null && beat > nextBeat >= 1) { 
				trace(nextBeat, (((nextBeat * 4) % soundBeats.length) + soundBeats.length) % soundBeats.length);
		...
		static public function setSimpleMetronome(measure:int, onBeat:FlxSound, offBeat:FlxSound = null, volume:Number = 1):void {
