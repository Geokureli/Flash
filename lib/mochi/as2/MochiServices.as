...
class mochi.as2.MochiServices {
     ...
     */
    public static function connect (id:String, clip:MovieClip, onError:Function):Void {
    ...
    private static function loadError(target_mc:MovieClip, errorCode:String, httpStatus:Number):Void {
        ...
        MochiServices.disconnect();
        MochiServices.onError(errorCode);
    };
    ...
    private static function initComChannels ():Void {
        if (!_connected) {
            ...
            _listenChannel.onError = function ():Void { MochiServices.onError("IOError"); };
