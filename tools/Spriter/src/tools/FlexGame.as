package tools {
	...
	import relic.data.helpers.MouseHelper;
	 ...
	 * @author George
	 */
	public class FlexGame extends UIComponent {
		...
		protected function init(e:Event = null):void {
			...
			stage.addEventListener(flash.events.FocusEvent.FOCUS_IN, onFocusLost);
			Keys.init(stage);
			MouseHelper.init(stage);
			scene = "main";
		}
